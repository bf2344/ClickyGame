    ...
    return (
      <div className="App">
        {/* <header className="App-header">
          ...
          <h1 className="App-title">This wedding is horseshit</h1>
        </header>  */}
        <h3 className="App-intro">
          <strong>Click on an Avenger to earn points, but don't click on any, more than once!</strong> 
      ...
      <div className="container">
        <span className="text-muted">&copy;Omar Abbasi - Clicky Game - React app.</span>
      </div>
    </footer> 
      </div>
    );
